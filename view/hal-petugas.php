				 ...
				 ?>
	 						<tr class="table table-default">
								...
								<td style="text-align: center;">
      								<a  class="btn edit" href="edit-buku.php?id_buku=<?php echo $d['id_buku']; ?> ">Edit</a>
      								<br>
      								<br>
      								<a  class="btn hapus" onClick="return confirm('Apakah anda yakin ingin menghapus?');"  href="hapus-buku.php?id_buku=<?php echo $d['id_buku']; ?>">Hapus</a>
   								</td>
							</tr>
	 <?php } ?>
	  </tbody>
